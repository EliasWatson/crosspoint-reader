...
class CrossPointSettings {
 ...
 public:
  ...
  // Font size options
  // EXTRA_SMALL is appended at the end to preserve storage compatibility with saved settings.
  // Only supported for NOTOSERIF; other families fall back to their SMALL size.
